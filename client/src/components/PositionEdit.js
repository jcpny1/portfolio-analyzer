...
export const PositionEdit = (props) => {
  ...
  return (
    <Form id='positionEditForm' onSubmit={onSubmit} error={Object.keys(formError).length !== 0}>
      <Form.Group>
        <Form.Input width={4} error={formError.name === 'stock_symbol_name'} label='Symbol' placeholder='Symbol' name='stock_symbol_name' value={position.stock_symbol_name} onChange={onChange} required/>
