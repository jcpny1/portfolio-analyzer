...
module DataCache
  ...
  SERIES_BATCH_DELAY = 12.0  # Delay time between series requests (in seconds) (Free Plan).
  # SERIES_BATCH_DELAY =  2.0  # Delay time between series requests (in seconds) (Premium Plan).
