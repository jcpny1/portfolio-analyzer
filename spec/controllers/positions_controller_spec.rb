...
RSpec.describe PositionsController, type: :controller do
  ...
  describe "POST #create" do
    it "creates a new position" do
      ...
      @position   = build(:position, portfolio: @portfolio, instrument: @instrument)
      post :create, { params: { portfolio_id: @position.portfolio.id, position: { instrument_id: @position.instrument.id, quantity: @position.quantity, cost: @position.cost, date_acquired: @position.date_acquired }}, format: :json }
