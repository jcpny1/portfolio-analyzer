...
Instrument.create(symbol: 'DJI',   name: 'Dow Jones')
...
Instrument.create(symbol: 'IWM',   name: 'Russel')
Instrument.create(symbol: 'JNJ',   name: 'Johnson & Johnson')
Instrument.create(symbol: 'QQQ',   name: 'NASDAQ')
Instrument.create(symbol: 'SNY',   name: 'SANOFI')
Instrument.create(symbol: 'SPY',   name: 'S&P 500')
Instrument.create(symbol: 'URTH',  name: 'MSCI World')
